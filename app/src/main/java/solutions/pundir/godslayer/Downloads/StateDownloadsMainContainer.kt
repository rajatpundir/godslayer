...
class StateDownloadsMainContainer {
    lateinit var torrents_fragmentDownloads : FragmentDownloadsTorrents
    lateinit var torrent_stats_fragmentDownloads : FragmentDownloadsTorrentStats
}