...
class RecycleViewAdapterPublishers internal constructor(context: Context?, val items: MutableList<Triple<Long, Long, String>>, val appStateHome : StateAppHome, parent_fragment : FargmentHomePublishers) : RecyclerView.Adapter<RecycleViewAdapterPublishers.HomeItemViewHolder>() {
