...
class RecycleViewAdapterLanguages internal constructor(context: Context?, val items: MutableList<Triple<Long, Long, String>>, val appStateHome : StateAppHome, val parent_fragment : FargmentHomeLanguages) : RecyclerView.Adapter<RecycleViewAdapterLanguages.HomeItemViewHolder>() {
