...
class RecycleViewAdapterLanguages internal constructor(context: Context?, val items: MutableList<Triple<Long, Long, String>>, val appStateHome : StateAppHome, parent_fragment : FargmentHomeLanguages) : RecyclerView.Adapter<RecycleViewAdapterLanguages.HomeItemViewHolder>() {
