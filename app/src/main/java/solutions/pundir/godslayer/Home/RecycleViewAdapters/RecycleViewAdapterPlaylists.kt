...
class RecycleViewAdapterPlaylists internal constructor(context: Context, val items: MutableList<String>) : RecyclerView.Adapter<RecycleViewAdapterPlaylists.HomeItemViewHolder>() {
