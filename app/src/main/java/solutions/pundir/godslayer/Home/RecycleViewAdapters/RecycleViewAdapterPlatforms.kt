...
class RecycleViewAdapterPlatforms internal constructor(context: Context, val items: MutableList<String>) : RecyclerView.Adapter<RecycleViewAdapterPlatforms.HomeItemViewHolder>() {
