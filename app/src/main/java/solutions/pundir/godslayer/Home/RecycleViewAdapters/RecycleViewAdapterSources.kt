...
class RecycleViewAdapterSources internal constructor(context: Context, val items: MutableList<String>) : RecyclerView.Adapter<RecycleViewAdapterSources.HomeItemViewHolder>() {
