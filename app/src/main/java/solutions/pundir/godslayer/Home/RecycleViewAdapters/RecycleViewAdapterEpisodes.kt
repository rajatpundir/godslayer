...
class RecycleViewAdapterEpisodes internal constructor(context: Context?, val items: MutableList<Triple<Long, Long, String>>, val parent_fragment : FargmentHomeEpisodes) : RecyclerView.Adapter<RecycleViewAdapterEpisodes.HomeItemViewHolder>() {
