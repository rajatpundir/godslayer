...
class RecycleViewAdapterEpisodes internal constructor(context: Context, val items: MutableList<String>) : RecyclerView.Adapter<RecycleViewAdapterEpisodes.HomeItemViewHolder>() {
